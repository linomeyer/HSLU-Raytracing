    ...
    public static Material Create(MaterialType type)
    {
        return type switch
        {
            ...
            MaterialType.CyanPlastic => new Material(type, new RgbColor(0.0, 0.1, 0.06), new RgbColor(0.0, 0.50980392, 0.50980392),
                new RgbColor(0.50196078, 0.50196078, 0.50196078), 0.25),
